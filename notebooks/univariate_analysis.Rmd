...
# knitr:
#   opts_chunk: 
#     fig.path: "customer_attrition_files/figure-gfm-"
---
...
ggplot(data, aes(x = Attrition)) +
  geom_bar(
    fill = "#264653",      # deep desaturated teal – professional tone
    color = "white",       # clean white border
    linewidth = 0.8        # a bit thicker outline for clarity
  ) +
  geom_text(
    stat = "count",
...
ggplot(data, aes(x = MonthlyIncome)) + 
  geom_histogram(
    ...
    color = "white",       # clean white border
    linewidth = 0.8,
    binwidth = 500 # a bit thicker outline for clarity
  ) +
